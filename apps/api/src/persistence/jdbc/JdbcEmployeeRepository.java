...
public class JdbcEmployeeRepository extends GenericJdbcRepository<Integer, Employee> implements EmployeeRepository {

    public JdbcEmployeeRepository(Connection connection) {
        super(connection, "employees", "employee_id", List.of(
            "first_name", "last_name", "email", "hire_date", "salary", "position_id", "department_id", "employee_type"
        ));
    }
    ...
    public void save(Employee entity) {
        ...
        try {
            ...
            throw new JdbcRepositoryException("Failed to save employee subtype details", e);
        }
    }
    ...
    @Override
    protected void bindSaveStatement(PreparedStatement ps, Employee entity) throws SQLException {
